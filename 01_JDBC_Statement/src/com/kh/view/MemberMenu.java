...
public class MemberMenu {
	...
	/**
	 * 이름으로 정보 조회 요청 후 조회 결과가 없을 경우 사용자가 보게 될 응답화면
	 * @param message
	 */
	public void displayNoName(String message) {
		System.out.println("\n" + message);
	}
	
	/**
	 * 이름으로 정보 조회 요청 후 조회된 데이터가 있을 경우 사용자가 보게 될 응답화면
	 * @param m			: 검색한 이름의 회원 정보
	 */
	public void displayNameResult(ArrayList<Member> nList) {
		System.out.println("\n 조회된 데이터는 다음과 같습니다.");
